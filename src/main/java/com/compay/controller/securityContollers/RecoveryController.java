...
public class RecoveryController {
    ...
    @RequestMapping(value = "/admin/resetUserPassword", method = RequestMethod.POST, produces = "text/plain;charset=UTF-8")
    @ResponseBody
    public String reset(@RequestHeader(value = "Content-Type") String contentType,
