...
Переменные среды пользователя. Создать 
	JRE_HOME  		C:\Program Files\Java\jre1.8.0_151 (или ваш путь к этой папке)
	CATALINA_HOME		D:\Development\Tomcat\apache-tomcat-8.5.23   (должно соответствовать вашему пути)
